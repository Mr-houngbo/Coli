...
import { Package, Plane, Shield, Zap, ArrowRight, Play, Sparkles, Globe, Sun, Moon } from 'lucide-react';
        ...
        <div className="text-center mb-24">
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center items-center mb-20">
            <button
              ...
              className="group relative bg-gradient-to-r from-violet-600 to-violet-500 px-12 py-5 rounded-2xl font-bold text-xl text-white transform hover:scale-110 transition-all duration-500 shadow-2xl hover:shadow-violet-500/50"
            >
            ...
            <button
              ...
              className={`group bg-transparent border-2 px-12 py-5 rounded-2xl font-bold text-xl transform hover:scale-110 transition-all duration-500 ${
                isDark 
